...
class TestOpenstackKeypair:
    ...
    def test_keypair_doesnt_exist(
        self, m_openstack, _m_public_key_content
    ):
    ...
    def test_keypairs_match(
        self, m_openstack, m_public_key_content
    ):
