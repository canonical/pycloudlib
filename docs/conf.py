...
latex_documents = [
    (master_doc, 'pycloudlib.tex', 'pycloudlib Documentation',
     'Joshua Powers', 'manual'),
]
...
man_pages = [
    (master_doc, 'pycloudlib', 'pycloudlib Documentation',
     [author], 1)
]
...
texinfo_documents = [
    (master_doc, 'pycloudlib', 'pycloudlib Documentation',
     author, 'pycloudlib', 'One line description of project.',
     'Miscellaneous'),
]
