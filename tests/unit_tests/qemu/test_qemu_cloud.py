...
class TestQemuCloud:
    def test_invalid_srcdir(self, tmp_path: Path):
    ...
    def test_invalid_destdir(self, tmp_path: Path):
    ...
    def test_get_available_dir(self, qemu, tmp_path: Path):
    ...
    def test_get_available_file(self, qemu, tmp_path: Path):
    ...
    def test_unparseable_release_page(self, qemu):
    ...
    def test_image_already_downloaded(self, _m_get, qemu, caplog):
    ...
    def test_seed_iso_no_data(self, tmp_path: Path, qemu):
    ...
    def test_seed_iso_only_vendordata(self, m_subp, qemu):
    ...
    def test_no_kernel_found(self, qemu, caplog):
    ...
    def test_instance_type(self, instance_type, expected, qemu):
