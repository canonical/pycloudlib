...
# prevent paramiko from spamming the console
...
def cloud(request):
    ...
    with request.param(
        ...
        # EC2 requires manually uploading ssh keys before launching instances, unlike other clouds
        # where the keys are uploaded automatically in cloud.launch()
