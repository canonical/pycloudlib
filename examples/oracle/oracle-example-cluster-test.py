...
def ensure_second_vnics_ready(test_cluster: List[OciInstance]):
    """
    Check if all cluster instances have a secondary VNIC.

    Args:
        cluster (List[OciInstance]): The cluster to verify.
    """
...
def get_private_nic_pci_address(instance: OciInstance):
    """Get the PCI address of the private VNIC of the instance."""
...
class TestOracleClusterOfedTools:
    ...
    def test_mst_status(self, cluster: List[OciInstance]):  # pylint: disable=W0621
        """
    ...
    def test_mlxconfig(self, cluster: List[OciInstance]):  # pylint: disable=W0621
        """
    ...
    def test_mlxfwmanager(self, cluster: List[OciInstance]):  # pylint: disable=W0621
        """
    ...
    def test_flint(self, cluster: List[OciInstance]):  # pylint: disable=W0621
        """
    ...
    def test_mlxfwreset(self, cluster: List[OciInstance]):  # pylint: disable=W0621
        """
